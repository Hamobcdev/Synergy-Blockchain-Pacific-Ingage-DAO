...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="max-w-5xl">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 mb-8 border border-white/20">
              <h2 className="text-2xl font-bold mb-4 text-cyan-300">
                Te Waka o te Taiao Hou • The Vessel to New Worlds
              </h2>
              <p className="text-xl leading-relaxed mb-6">
                Like our tīpuna who navigated vast Pacific waters in their waka
                hourua, we embark on a collective journey into the blockchain
                frontier. <strong>Every paddler matters</strong> — each
                contribution propels us toward new horizons of transparency,
            ...
            <p className="text-xl mb-8 leading-relaxed max-w-4xl">
              Built on the <strong>REM (Relationship Equity Management)</strong>{" "}
              framework, our DAO honors <strong>manaakitanga</strong> and{" "}
              <strong>whakatōhea</strong> — delivering transparent performance
              tracking and community collaboration for Pacific Islands and
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-start">
              ...
              <div className="text-sm text-white/80 flex items-center space-x-2 bg-white/10 px-4 py-3 rounded-lg backdrop-blur-sm">
                ...
                <span>
                  Prepared: June 12, 2025 • Synergy Blockchain Pacific
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              A phased, milestone-driven approach to build a replicable platform
              for managing performance-based rewards, governance, and
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl border border-blue-100 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">
                Pono • Transparent Tracking
              </h3>
              <p className="text-gray-600 leading-relaxed">
                All contributions and results tracked on-chain with full
                transparency, honoring the principle of pono (righteousness)
              </p>
            </div>
            <div className="text-center p-8 bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl border border-green-100 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">
                Mātauranga • Knowledge Rewards
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Verified knowledge sharing earns tokens and builds reputation,
            ...
            <div className="text-center p-8 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border border-purple-100 hover:shadow-lg transition-all duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">
                Whakatōhea • Collective Impact
              </h3>
              <p className="text-gray-600 leading-relaxed">
                Scalable platform for iwi and island development models,
      ...
      <section
        id="about"
        className="py-16 bg-gradient-to-br from-gray-50 to-blue-50 relative"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-gray-900 mb-8 text-center">
              He Aha Tēnei Kaupapa • Why This Matters
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Every contribution, milestone, and outcome is recorded
                  on-chain, creating an immutable record of performance and
                  ensuring all stakeholders have access to real-time project
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Decentralized decision-making empowers community members to
                  have a direct voice in project direction, resource allocation,
                  and strategic decisions through culturally-appropriate
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Specifically designed for Pacific Islands and Indigenous
                  communities, incorporating cultural values, traditional
                  governance structures, and tikanga Māori into modern
              ...
              <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition-all duration-300">
                ...
                <p className="text-gray-600 leading-relaxed">
                  The REM framework can be adapted and replicated across
                  different communities, creating a network of interconnected
                  DAOs that share knowledge, resources, and cultural wisdom
                  across the Pacific.
                </p>
              </div>
            </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Rautaki • Project Timeline
            </h2>
            <p className="text-lg text-gray-600">
              24-week development cycle with 4 distinct phases
            </p>
          </div>
          <div className="space-y-8">
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6 p-8 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl border border-blue-100">
              <div className="flex-shrink-0 w-20 h-20 bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-2xl flex items-center justify-center font-bold text-2xl shadow-lg">
                1
              </div>
              <div className="flex-grow">
                ...
                <p className="text-gray-700 mb-4 text-lg">
                  <strong>Weeks 1-4:</strong> Define objectives, test
                  assumptions with QTM modeling, create system architecture
                </p>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6 p-8 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl border border-green-100">
              <div className="flex-shrink-0 w-20 h-20 bg-gradient-to-br from-green-600 to-green-700 text-white rounded-2xl flex items-center justify-center font-bold text-2xl shadow-lg">
                2
              </div>
              <div className="flex-grow">
                <h3 className="text-2xl font-semibold text-gray-900 mb-3">
                ...
                <p className="text-gray-700 mb-4 text-lg">
                  <strong>Weeks 5-8:</strong> Design smart contracts, cadCAD
                  simulation modeling, define governance rules
                </p>
                <div className="flex flex-wrap gap-3">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6 p-8 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl border border-purple-100">
              <div className="flex-shrink-0 w-20 h-20 bg-gradient-to-br from-purple-600 to-purple-700 text-white rounded-2xl flex items-center justify-center font-bold text-2xl shadow-lg">
                3
              </div>
              <div className="flex-grow">
                <h3 className="text-2xl font-semibold text-gray-900 mb-3">
                ...
                <p className="text-gray-700 mb-4 text-lg">
                  <strong>Weeks 9-16:</strong> Web dashboard, testnet
                  deployment, milestone-based payment simulation
                </p>
                <div className="flex flex-wrap gap-3">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-4 md:space-y-0 md:space-x-6 p-8 bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl border border-orange-100">
              <div className="flex-shrink-0 w-20 h-20 bg-gradient-to-br from-orange-600 to-orange-700 text-white rounded-2xl flex items-center justify-center font-bold text-2xl shadow-lg">
                4
              </div>
              <div className="flex-grow">
                <h3 className="text-2xl font-semibold text-gray-900 mb-3">
                  Testing & DAO Onboarding
                </h3>
                <p className="text-gray-700 mb-4 text-lg">
                  <strong>Weeks 17-24:</strong> Beta testing with partners,
                  governance voting, Knowledge NFT module
                </p>
                <div className="flex flex-wrap gap-3">
      ...
      <section
        id="payment"
        className="py-16 bg-gradient-to-br from-gray-50 to-indigo-50"
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Utu • Investment & Payment
            </h2>
            <p className="text-lg text-gray-600">
              Flexible payment options designed to accommodate different funding
              scenarios
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
              ...
              <p className="text-sm text-gray-600 mt-6 bg-gray-50 p-4 rounded-lg">
                Includes AI tools, blockchain infrastructure, hosting, testing
                costs, and cultural consultation
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="p-6 bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl border border-blue-200">
                  <h4 className="font-bold text-blue-900 mb-2 text-lg">
                    Option A: Delivery Payment
                  </h4>
                  <p className="text-blue-800">
                    Pay remainder at MVP delivery milestone
                  </p>
                </div>
                <div className="p-6 bg-gradient-to-r from-purple-50 to-purple-100 rounded-xl border border-purple-200">
                  <h4 className="font-bold text-purple-900 mb-2 text-lg">
                    Option B: Equity Conversion
                  </h4>
                  <p className="text-purple-800">
                    Convert to shared IP or DAO equity partnership
                  </p>
                </div>
                <div className="p-6 bg-gradient-to-r from-green-50 to-green-100 rounded-xl border border-green-200">
                  <h4 className="font-bold text-green-900 mb-2 text-lg">
                    Option C: Funding Match
                  </h4>
                  <p className="text-green-800">
                    Match via iwi or NZ funding agency (Te Puni Kōkiri)
                  </p>
                </div>
              </div>
            </div>
      ...
      <section id="collaboration" className="py-16 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">
              Whakatōhea • Co-Creation Partnership
            </h2>
            <p className="text-lg text-gray-600">
              Building together with Pacific communities and technical partners
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-gradient-to-br from-blue-50 to-cyan-100 rounded-2xl border border-blue-200 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Māori or Pacific developers join from Week 6+ with ownership
                potential and cultural guidance
              </p>
            ...
            <div className="text-center p-8 bg-gradient-to-br from-green-50 to-emerald-100 rounded-2xl border border-green-200 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Involve iwi directly in governance, testing, and reward systems
            ...
            <div className="text-center p-8 bg-gradient-to-br from-purple-50 to-pink-100 rounded-2xl border border-purple-200 hover:shadow-lg transition-all duration-300">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Support an open-source, scalable impact platform for Pacific
                innovation
              </p>
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
                ...
                <div className="text-sm opacity-90 mt-2">
                  Milestone-based payouts with transparency
                </div>
              </div>
              <div className="bg-white/10 p-6 rounded-xl backdrop-blur-sm">
                <CheckCircle className="h-10 w-10 mx-auto mb-4" />
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 mb-12">
            Ready to build a transparent, equitable Pacific innovation system —
          ...
          <div className="bg-white p-10 rounded-2xl shadow-lg border border-gray-200 mb-8">
            ...
            <div className="space-y-4 text-left max-w-2xl mx-auto">
              <div className="flex items-start space-x-4 p-4 bg-green-50 rounded-xl">
                ...
                <span className="text-gray-700 font-medium">
                  Confirm weekly payment structure or choose deferred option
                </span>
              </div>
              <div className="flex items-start space-x-4 p-4 bg-blue-50 rounded-xl">
                <CheckCircle className="h-6 w-6 text-blue-600 flex-shrink-0 mt-1" />
                <span className="text-gray-700 font-medium">
                  Approve project phases and team invitation process
                </span>
              </div>
              <div className="flex items-start space-x-4 p-4 bg-purple-50 rounded-xl">
                <CheckCircle className="h-6 w-6 text-purple-600 flex-shrink-0 mt-1" />
                <span className="text-gray-700 font-medium">
                  Launch system mapping and cultural integration in Week 1
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              ...
              <div className="space-y-3 text-gray-600 mb-6">
                ...
                <div>
                  <strong>For:</strong> Stakeholders and Community Partners
                </div>
              </div>
              <a
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              ...
              <div className="space-y-3 text-gray-600 mb-6">
                <div>
                  <strong>Direct messaging for:</strong>
                </div>
      ...
      <footer className="bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 text-white py-12 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative">
          ...
          <p className="text-gray-400 text-sm">
            Honoring traditional values • Embracing technological innovation •
